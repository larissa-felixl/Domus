...
<head>
    ...
    <title>Atualize dados da visita</title>
...
<body class="bg-gray-100 h-full flex flex-col">
    ...
    <div class="m-7 rounded-lg py-3 shadow-sm" style="background-color: #E5E7E9;">
        <h1 class="m-5 font-semibold text-xl text-gray-700">Atualize os dados da visita</h1>
    </div>
    ...
    <div class="m-7">
        <form action="{{ route('visits.update', $visit->id) }}" method="POST">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <h2 class="text-xl font-semibold text-gray-700 mb-6 pb-3 ">Atualize com as informações corretas da Visita</h2>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="time" id="time" value="{{ old('time', $visit->time) }}" required
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full px-4 py-2 border border-gray-400 rounded-lg focus:ring-2 focus:ring-gray-400 focus:border-transparent transition">{{ old('description', $visit->description) }}</textarea>
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
